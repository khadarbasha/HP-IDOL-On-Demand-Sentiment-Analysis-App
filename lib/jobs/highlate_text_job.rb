class HighlightTextJob < Struct.new(:tweet)
  def perform
    url = Constants::HPOnDemandAPI::BASE_URL+Constants::HPOnDemandAPI:: HighlightText::END_POINT
    ...
    uri.query = URI.encode_www_form(
      'text' => tweet.text,'apikey'=>api_key
      )
